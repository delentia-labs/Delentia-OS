...
async def _lifespan(app: FastAPI):
    ...
    # Round 36 Task 82 / Round 37 / Round 38: additional real input
    # sources alongside the reminder poller, proving the "pluggable
    # input source" architecture with real second/third/fourth adapters.
    # Each honestly no-ops (logs a warning, does not error) when its own
    # token(s) aren't set - matching this engagement's established
